...
public class MovieAdapter<T> extends RecyclerView.Adapter<MovieAdapter.DiscoverViewHolder> {
    ...
    public void addmovieList(List<T> movieList) {
        List<T> sumList = this.movieList;
